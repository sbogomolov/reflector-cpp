...
ROUNDTRIP_CASES = [
    ...
    # sees it there and its unicast 200 OK must land on that same routable address, not the link-local
    # one. Guards the scope-matched session address in MakeSession.
